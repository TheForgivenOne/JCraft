      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 lg:px-20 py-8">
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">Our Craftsmanship</h1>
            <p className="text-lg text-[#9a734c] leading-relaxed">
              A curated collection of handmade goods, blending traditional techniques with modern aesthetics. Each piece tells a story of patience and precision.
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="w-full lg:w-64 shrink-0">
            <div className="flex flex-col gap-8 sticky top-24">
              ...
              {/* Materials Section */}
              <div>
                <h3 className="text-sm font-bold uppercase tracking-widest text-[#9a734c] mb-4">Materials</h3>
                <div className="flex flex-col gap-1">
                  <label className="flex items-center gap-3 px-3 py-2 cursor-pointer group">
                    <input defaultChecked={true} className="rounded border-[#9a734c] text-primary focus:ring-primary" type="checkbox"/>
                    <span className="text-sm group-hover:text-primary transition-colors">Reclaimed Oak</span>
                  </label>
                  <label className="flex items-center gap-3 px-3 py-2 cursor-pointer group">
                    <input className="rounded border-[#9a734c] text-primary focus:ring-primary" type="checkbox"/>
                    <span className="text-sm group-hover:text-primary transition-colors">Wrought Iron</span>
                  </label>
                  <label className="flex items-center gap-3 px-3 py-2 cursor-pointer group">
                    <input className="rounded border-[#9a734c] text-primary focus:ring-primary" type="checkbox"/>
                    <span className="text-sm group-hover:text-primary transition-colors">Aged Brass</span>
                  </label>
                  <label className="flex items-center gap-3 px-3 py-2 cursor-pointer group">
                    <input className="rounded border-[#9a734c] text-primary focus:ring-primary" type="checkbox"/>
                    <span className="text-sm group-hover:text-primary transition-colors">Full-Grain Leather</span>
                  </label>
                </div>
              </div>
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Woodworking</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Live Edge Dining Table</h3>
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Metalwork</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Forged Steel Sconce</h3>
                  <p className="text-sm text-[#9a734c] line-clamp-2 leading-relaxed">
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Leather</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Artisan Leather Satchel</h3>
                  <p className="text-sm text-[#9a734c] line-clamp-2 leading-relaxed">
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Home Decor</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Aged Brass Desk Clock</h3>
                  <p className="text-sm text-[#9a734c] line-clamp-2 leading-relaxed">
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Furniture</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Sculptural Lounge Chair</h3>
                  <p className="text-sm text-[#9a734c] line-clamp-2 leading-relaxed">
              ...
              <div className="group craft-card relative flex flex-col overflow-hidden bg-white dark:bg-[#2b2118] rounded-xl border border-[#f3ede7] dark:border-[#3d2e21] hover:shadow-2xl hover:shadow-primary/5 transition-all">
                ...
                <div className="p-6">
                  <span className="text-[10px] font-bold tracking-widest text-[#9a734c] uppercase">Tools</span>
                  <h3 className="text-lg font-bold mt-1 mb-2">Master Chisel Set</h3>
                  <p className="text-sm text-[#9a734c] line-clamp-2 leading-relaxed">
            ...
            <div className="mt-16 flex justify-center items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="size-10 rounded-lg flex items-center justify-center hover:bg-[#f3ede7] dark:hover:bg-[#3d2e21] font-medium">2</button>
                <button className="size-10 rounded-lg flex items-center justify-center hover:bg-[#f3ede7] dark:hover:bg-[#3d2e21] font-medium">3</button>
