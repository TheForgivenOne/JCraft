    ...
    <div className="bg-background-light dark:bg-background-dark text-[#1b140d] dark:text-[#f3ede7] font-display min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-10">
          <div className="flex flex-col gap-6 py-12 md:py-20 lg:flex-row items-center lg:gap-16">
            <div 
              ...
              style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAhuTgD5F9wYJLX5twrz4Y47JE_EcrTVPPSvOp0j6XiUxW1YDkmljXniUOZ3PFdf1FOZCOPj2NTi02pHDbJ5aCrEn408G_LBsg2-nzQ0l8-m0Prsu_1DrXagn9KwfVzwPxggvb8Fj7_xWbkuHDi1uh5EvN9GdqzduTxT8-qUuBBglqNkwECKHcPMD14jSyhG-IDcII1Hju-MtKzNr6Sx9mjKzEGUvqUBY_49fkL2gQO2BMNQO4976Bz8vVTWZNBgmpdh-5nNtlTFB88')" }}
            ></div>
            <div className="flex flex-col gap-8 w-full lg:w-1/2">
              <div className="flex flex-col gap-4">
                <span className="text-primary font-bold tracking-widest uppercase text-sm">Since 2015</span>
                ...
                <p className="text-[#1b140d]/80 dark:text-[#f3ede7]/80 text-lg md:text-xl font-normal leading-relaxed">
                  Our story began in a small garage with a single set of chisels and a vision to create goods that last generations. We believe the soul of an object is born in the workshop, through the patient hands of the maker.
                </p>
              </div>
        ...
        <section className="bg-cream/30 dark:bg-white/5 py-20">
          <div className="max-w-[960px] mx-auto px-10">
            <div className="text-center mb-16">
              <h2 className="text-[#1b140d] dark:text-white text-4xl font-bold leading-tight tracking-tight">The Journey</h2>
            ...
            <div className="grid grid-cols-[40px_1fr] gap-x-8 px-4">
              ...
              <div className="flex flex-1 flex-col pb-10">
                <p className="text-primary text-sm font-bold tracking-wider uppercase mb-1">2015</p>
                <p className="text-[#1b140d] dark:text-white text-xl font-bold leading-normal">The First Workshop</p>
                <p className="text-clay dark:text-clay/80 text-base font-normal leading-relaxed mt-2">
                  Founded in a small barn in Oregon, JCraft started with a focus on custom leather journals and hand-carved desk accessories.
                </p>
              </div>
              {/* Item 2 */}
              <div className="flex flex-col items-center gap-1">
              ...
              <div className="flex flex-1 flex-col pb-10">
                <p className="text-primary text-sm font-bold tracking-wider uppercase mb-1">2018</p>
                <p className="text-[#1b140d] dark:text-white text-xl font-bold leading-normal">Expanding the Team</p>
                <p className="text-clay dark:text-clay/80 text-base font-normal leading-relaxed mt-2">
                  We moved to our current studio and welcomed three master craftsmen, allowing us to venture into furniture and luxury lifestyle goods.
                </p>
              </div>
              {/* Item 3 */}
              <div className="flex flex-col items-center gap-1">
              ...
              <div className="flex flex-1 flex-col">
                <p className="text-primary text-sm font-bold tracking-wider uppercase mb-1">2022</p>
                <p className="text-[#1b140d] dark:text-white text-xl font-bold leading-normal">Global Recognition</p>
                <p className="text-clay dark:text-clay/80 text-base font-normal leading-relaxed mt-2">
                  Honored with the "Sustainability in Craft" award and started shipping our handmade collections to over 40 countries.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[1200px] mx-auto px-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              <div className="max-w-2xl">
                ...
                <h3 className="text-[#1b140d] dark:text-white text-4xl md:text-5xl font-black leading-tight tracking-tight">Our Process</h3>
                <p className="text-clay dark:text-clay/80 text-lg mt-4">We take the long way around. No shortcuts, just pure dedication to the craft.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group bg-white dark:bg-white/5 p-8 rounded-xl border border-cream dark:border-white/10 hover:border-primary transition-all shadow-sm hover:shadow-xl">
                ...
                <p className="text-clay dark:text-clay/80 text-sm leading-relaxed">
                  We hand-select premium, sustainably harvested materials from local suppliers who share our ethics.
                </p>
              </div>
              {/* Step 2 */}
              <div className="group bg-white dark:bg-white/5 p-8 rounded-xl border border-cream dark:border-white/10 hover:border-primary transition-all shadow-sm hover:shadow-xl">
                ...
                <p className="text-clay dark:text-clay/80 text-sm leading-relaxed">
                  Every piece is sketched and prototyped until form and function reach perfect equilibrium.
                </p>
              </div>
              {/* Step 3 */}
              <div className="group bg-white dark:bg-white/5 p-8 rounded-xl border border-cream dark:border-white/10 hover:border-primary transition-all shadow-sm hover:shadow-xl">
                ...
                <p className="text-clay dark:text-clay/80 text-sm leading-relaxed">
                  Slow-made by hand using traditional techniques. We don't rush excellence.
                </p>
              </div>
              {/* Step 4 */}
              <div className="group bg-white dark:bg-white/5 p-8 rounded-xl border border-cream dark:border-white/10 hover:border-primary transition-all shadow-sm hover:shadow-xl">
                ...
                <p className="text-clay dark:text-clay/80 text-sm leading-relaxed">
                  Hand-applied natural oils and waxes protect and highlight the natural beauty of the material.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-forest py-24 text-white">
          <div className="max-w-[1200px] mx-auto px-10">
            <div className="text-center mb-16">
              <h2 className="text-primary text-sm font-bold tracking-widest uppercase mb-4">Our Core Values</h2>
              <h3 className="text-4xl md:text-5xl font-black">Built for the long run</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-white/10 p-10 rounded-2xl flex flex-col justify-between hover:bg-white/15 transition-colors">
                ...
                <div className="flex gap-4">
                  <span className="px-3 py-1 bg-white/10 rounded text-xs font-bold uppercase tracking-tighter">FSC Certified</span>
                  <span className="px-3 py-1 bg-white/10 rounded text-xs font-bold uppercase tracking-tighter">Zero Waste</span>
                </div>
              </div>
              {/* Quality */}
        ...
        <section className="py-24 text-center">
          <div className="max-w-[800px] mx-auto px-10">
            <h2 className="text-[#1b140d] dark:text-white text-4xl font-bold mb-8">Own a piece of the story.</h2>
            <p className="text-clay text-lg mb-10">Explore our seasonal collections or request a custom commission today.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="bg-primary text-white font-bold py-4 px-10 rounded-lg hover:opacity-90 transition-all text-lg">Shop the Collection</button>
              <button className="border-2 border-primary text-primary font-bold py-4 px-10 rounded-lg hover:bg-primary/5 transition-all text-lg">Contact the Studio</button>
            </div>
          </div>
        </section>
      </main>
