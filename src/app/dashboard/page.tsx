    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background-light dark:bg-background-dark">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-[#1b140d] dark:text-white">
            Access Denied
          </h1>
          <p className="text-[#9a734c] dark:text-[#d1c2b5] mt-2">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e5e7eb] dark:border-[#3d2e1f] px-6 lg:px-10 py-3 bg-white dark:bg-[#2d2116] sticky top-0 z-50">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4 text-primary">
            ...
            <h2 className="text-[#1b140d] dark:text-white text-xl font-bold leading-tight tracking-[-0.015em] font-display">
              JCraft
            </h2>
          </div>
          <div className="hidden md:flex items-center gap-9">
            <Link
              href="/#explore"
              className="text-[#1b140d] dark:text-[#d1c2b5] text-sm font-medium hover:text-primary transition-colors"
            >
              Explore
            </Link>
            <Link
        ...
        <div className="flex flex-1 justify-end gap-6 items-center">
          <label className="hidden md:flex flex-col min-w-40 !h-10 max-w-64">
            <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
              <div
                className="text-[#9a734c] flex border-none bg-[#f3ede7] dark:bg-[#3d2e1f] items-center justify-center pl-4 rounded-l-lg"
                data-icon="search"
              >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80')",
            }}
          >
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden lg:flex w-64 flex-col border-r border-[#e5e7eb] dark:border-[#3d2e1f] bg-white dark:bg-[#2d2116] p-4 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <Link
              href="/dashboard"
              className="flex items-center gap-3 px-3 py-2 text-[#6b7280] dark:text-[#d1c2b5] hover:bg-background-light dark:hover:bg-[#3d2e1f] rounded-lg transition-colors cursor-pointer"
            >
            ...
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2 text-[#6b7280] dark:text-[#d1c2b5] hover:bg-background-light dark:hover:bg-[#3d2e1f] rounded-lg transition-colors cursor-pointer relative"
            >
        ...
        <main className="flex-1 flex flex-col min-w-0 max-w-[1200px] mx-auto p-6 lg:p-10 gap-8">
          ...
          <div className="flex flex-wrap justify-between items-end gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#9a734c] dark:text-[#d1c2b5] text-base font-normal">
          ...
          <section className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h2 className="text-[#1b140d] dark:text-white text-xl font-bold font-display">
                Active Commissions
              </h2>
                ...
                <div className="flex-1 p-6 md:p-8 flex flex-col justify-between gap-6">
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-[#1b140d] dark:text-white text-2xl font-bold font-display">
                        Walnut Dining Table
                      </h3>
                    ...
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      />
                      <p className="text-[#9a734c] dark:text-[#d1c2b5] text-sm">
                        Phase:{" "}
                        <span className="text-[#1b140d] dark:text-white font-semibold">
                          Sanding & Polishing
                        </span>
                      </p>
                    </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-1">
                      <h4 className="text-sm font-bold">
                        Julian (Master Craftsman)
                      </h4>
                      <span className="text-[10px] text-[#9a734c] uppercase font-bold">
                        2 hours ago
                      </span>
                    </div>
                    <p className="text-sm text-[#1b140d] dark:text-[#d1c2b5] line-clamp-2">
                      &quot;Just finished the final oil coat on the legs. The
                      grain is looking absolutely stunning. I&apos;ll send some
                      more hi-res photos tomorrow.&quot;
                    </p>
                  </div>
                </div>
          ...
          <footer className="mt-8 py-10 border-t border-[#e5e7eb] dark:border-[#3d2e1f] flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-[#9a734c] text-[10px] uppercase font-bold tracking-widest">
              © 2023 JCraft Studios
            </p>
          </footer>
        </main>
