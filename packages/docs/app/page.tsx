...
import { BookOpen, FolderGit, Server, Shield, Palette, Code } from 'lucide-react';
          ...
          <CardContent>
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                ...
                project, including setup instructions, API documentation, and best
                practices.
              </p>
              ...
              <ul>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">apps/web</code> - Main Next.js web application
                </li>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">apps/docs</code> - Documentation site
                </li>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">packages/ui</code> - Shared UI components
                </li>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">packages/utils</code> - Shared utilities
                </li>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">packages/types</code> - Shared TypeScript types
                </li>
                <li>
                  <code className="bg-muted px-1.5 py-0.5 rounded">packages/config</code> - Shared configuration
                </li>
              </ul>
