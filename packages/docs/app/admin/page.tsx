...
import { FileText, BookOpen, Settings, Users, Plus, BarChart3, Eye, Activity } from 'lucide-react';
import Link from 'next/link';

export default function DocsAdminPage() {
  const stats = [
    { name: "Total Pages", value: "24", icon: <FileText className="h-5 w-5" /> },
  ...
  const quickActions = [
    { name: "Add New Page", href: "/admin/docs/pages/new", icon: <Plus className="h-4 w-4" /> },
    { name: "Manage Categories", href: "/admin/docs/categories", icon: <BookOpen className="h-4 w-4" /> },
    { name: "Documentation Settings", href: "/admin/docs/settings", icon: <Settings className="h-4 w-4" /> },
    { name: "View Analytics", href: "/admin/docs/analytics", icon: <BarChart3 className="h-4 w-4" /> }
  ];

  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Documentation Admin</h1>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">by Jane Smith • 5 hours ago</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="p-2 rounded-full bg-primary/10 text-primary mt-0.5">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Documentation published</p>
                    <p className="text-xs text-muted-foreground">by Alex Johnson • 1 day ago</p>
                  </div>
                </div>
              </div>
            </CardContent>
