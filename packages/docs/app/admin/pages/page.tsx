...
export default function DocsPagesPage() {
  ...
  const pages = [
    { id: 1, title: "Getting Started", category: "Introduction", lastUpdated: "2023-10-15", author: "John Doe" },
    { id: 2, title: "Installation Guide", category: "Setup", lastUpdated: "2023-10-12", author: "Jane Smith" },
    { id: 3, title: "API Reference", category: "Development", lastUpdated: "2023-10-10", author: "Alex Johnson" },
    { id: 4, title: "Authentication", category: "Security", lastUpdated: "2023-10-08", author: "Sarah Williams" },
    { id: 5, title: "Deployment", category: "Production", lastUpdated: "2023-10-05", author: "Mike Brown" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Documentation Pages</h1>
