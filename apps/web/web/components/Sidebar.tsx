...
const Sidebar = ({ className }: SidebarProps) => {
  ...
  const navItems = [
    { name: 'Dashboard', href: '/dashboard' as any, icon: HomeIcon },
    { name: 'Products', href: '/products' as any, icon: StoreIcon },
    { name: 'Orders', href: '/orders' as any, icon: ShoppingCartIcon },
    { name: 'Projects', href: '/projects' as any, icon: PackageIcon },
