      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent>
          <div className="prose max-w-none">
            ...
            <ul>
              <li>
                <code>apps/web</code> - Main Next.js web application
              </li>
              <li>
                <code>apps/docs</code> - Documentation site
              </li>
              <li>
                <code>packages/ui</code> - Shared UI components
              </li>
              <li>
                <code>packages/utils</code> - Shared utilities
              </li>
              <li>
                <code>packages/types</code> - Shared TypeScript types
              </li>
              <li>
                <code>packages/config</code> - Shared configuration
              </li>
            </ul>
